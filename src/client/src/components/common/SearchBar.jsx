         ...
         >
           <div className="form-row row">
             <div className="form-group col-4">
               <div style={child1}>
               <input type="text" list="topdestinations" style={inputStyle} placeholder="Where to next?"/>
               <img type="search" src="https://d344sq77q05r9.cloudfront.net/prod-20-07-22-13:01/assets/8d5ffea350722a76661c3e841b6d24ee.svg" alt="search" style={searchImgStyle}/>
               </div>
