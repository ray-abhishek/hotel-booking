...
export const userRegistration=query=>dispatch=>{
    ...
    return(
        axios.post("https://8e4bf9ff024c.ngrok.io/signup",{
            email: query.email,
            name: query.name,
...
export const userLogin=query=>dispatch=>{
    ...
    return (
        axios.post("https://8e4bf9ff024c.ngrok.io/login",{      
            email: query.email,         
            password: query.password
    }).then(loginRes=>{
...
export const googleLogin=query=>dispatch=>{
    ...
    return (
        axios.post("https://8e4bf9ff024c.ngrok.io/ssologin",{      
...
export const logoutUser=query=>dispatch=>{
    dispatch(logout())
    return (
        axios.get("https://8e4bf9ff024c.ngrok.io/logout")
        .then(logoutRes=>{
